...
public abstract class GenericDAO<T extends Persistence, E extends Serializable> implements IGenericDAO<T, E> {
    ...
    protected abstract void setParametrosQueryInsercao(PreparedStatement stmInsert, Cliente_2 entity)
            throws SQLException;
    ...
    protected abstract void setParametrosQueryAtualizacao(PreparedStatement stmUpdate, Produto_4 entity)
            throws SQLException;

    protected abstract void setParametrosQuerySelect(PreparedStatement stmExclusao, String valor) throws SQLException;

    protected abstract void setParametrosQueryAtualizacao(PreparedStatement stmUpdate, Cliente_2 entity)
            throws SQLException;
